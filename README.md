...
|---|---|---|---|---|
| 1 | **Foundations of features** | Features vs targets, the identifier trap, feature type taxonomy, why engineering beats tuning | [.ipynb](1.%20Foundations_of_features.ipynb) | [Article](https://shikharkumar13.github.io/Feature_Engineering/Foundations-of-Features-Explained.html) |
| 2 | **Data understanding and cleaning** | MCAR/MAR/MNAR measured as bias, five imputers scored against ground truth, outlier masking, duplicates hidden behind IDs | [.ipynb](2.%20Data_Cleaning.ipynb) | [Article](https://shikharkumar13.github.io/Feature_Engineering/Data-Understanding-and-Basic-Cleaning-Explained.html) |
| 3 | **Numeric transformations** | Scaling, log and power transforms, Box-Cox vs Yeo-Johnson, binning, and why polynomial features on raw data give R2 of -11.16 | [.ipynb](3.%20Numeric%20Transformations.ipynb) | [Article](https://shikharkumar13.github.io/Feature_Engineering/Feature-Transformation-for-Numeric-Variables-Explained.html) |
| 4 | **Categorical encoding** | Ordinal vs nominal, one hot, target encoding and its leak, frequency encoding, hashing, unseen categories, rare grouping | [.ipynb](4.%20Categorical_Encoding.ipynb) | [Article](https://shikharkumar13.github.io/Feature_Engineering/Feature-Engineering-for-Categorical-Variables-Explained.html) |
